...
class TestAuthor:
    ...
    def test_name_is_immutable_string(self):
        ...
        # Test immutability of the name by raising an Exception
    ...
    def test_name_len(self):
        """Author name must be longer than 0 characters"""
        author_1 = Author("Carry Bradshaw")
        author_2 = Author("Nathaniel Hawthorne")
        ...
        # Test empty name raises Exception
        with pytest.raises(Exception):
            Author("")
    ...
    def test_magazines_of_type_magazine(self):
        ...
        # Verify magazines are of type Magazine
