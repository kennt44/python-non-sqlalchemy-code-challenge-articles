...
class TestArticle:
    ...
    def test_title_is_immutable_str(self):
        ...
        # Verify the title cannot be reassigned (immutable)
    ...
    def test_title_is_valid(self):
        ...
        # Verify the title length constraints
        assert 5 <= len(article_1.title) <= 50

        # Test short and long titles (should raise exceptions)
        with pytest.raises(Exception):
    ...
    def test_has_an_author(self):
        ...
        # Verify the authors are correctly assigned
    ...
    def test_author_of_type_author_and_mutable(self):
        ...
        # Verify initial author
        assert isinstance(article_1.author, Author)
        assert article_1.author.name == "Carry Bradshaw"

        # Change the author and verify
    ...
    def test_has_a_magazine(self):
        ...
        # Verify the magazines are correctly assigned
    ...
    def test_magazine_of_type_magazine_and_mutable(self):
        ...
        # Verify the initial magazine
        assert isinstance(article_1.magazine, Magazine)
        assert article_1.magazine.name == "Vogue"

        # Change the magazine and verify
        article_1.magazine = magazine_2
        assert isinstance(article_1.magazine, Magazine)
        assert article_1.magazine.name == "AD"

    def test_get_all_articles(self):
        """Article class keeps track of all articles"""
